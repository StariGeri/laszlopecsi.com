...
const Slide = ({ slide }: SlideProps) => {
    ...
    return (
        <Link href={`/collection/${slide.id}`}>
            <div className="w-full flex flex-col sm:flex-row cursor-pointer">
                <Image src={slide.images[0]} alt={slide.title} width={500} height={500} className='w-full h-auto max-h-[300px] sm:w-[350px] lg:w-[400px] object-cover' />
                <div className='p-2 md:p-3 lg:p-4 flex flex-col gap-2 justify-between w-full sm:w-1/2'>
