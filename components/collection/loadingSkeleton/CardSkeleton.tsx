const CardSkeleton = () => {
    ...
    return (
        <div role="status" className="w-full h-[300px] md:h-[390px] lg:h-[420px] xl:h-[470px] flex flex-col mx-auto animate-pulse">
            <div className="flex items-center justify-center h-48 mb-4 bg-gray-300">
