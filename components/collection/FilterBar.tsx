    ...
    return (
        <div className="w-full max-w-[1240px] flex items-center gap-4 lg:gap-12 mx-auto">
            ...
            <div className="w-full flex-grow-0 relative">
                <input type="text" placeholder="Search" className="w-full h-10 md:h-12 pl-12 pr-4 border border-slate-900 rounded-lg focus:outline-none placeholder:font-body placeholder:text-lg placeholder:text-slate-900" />
