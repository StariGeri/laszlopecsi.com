...
const OtherContacts = () => {
    return (
        <div className='flex flex-col w-full sm:w-1/3 p-2 md:p-4 lg:p-6'>
            <h1 className="className=' text-lg md:text-xl lg:text-[22px] font-body mb-2 sm:mb-3">Write us at</h1>
            ...
            <h1 className="className=' text-lg md:text-xl lg:text-[22px] font-body mb-1 mt-12">Find us on</h1>
